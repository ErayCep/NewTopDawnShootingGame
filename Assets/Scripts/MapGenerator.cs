...
public class MapGenerator : MonoBehaviour
{
    ...
    public void GenerateMap()
    {
        ...
        List<Coord> allOpenCoords = new List<Coord>(shuffledTileCoord);
        for(int i = 0; i < obstacleCount; i++)
        {
            ...
            if(randomCoord.x != currentMap.mapCenter.x && randomCoord.y != currentMap.mapCenter.y && MapIsFullyAccessible(obstacleMap, currentObstacleCount))
            {
